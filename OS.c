...
void setup(char inputBuffer[], char *args[], int *background)
{
    ...
    for (i = 0; i < length; i++) {
        ...
        switch (inputBuffer[i]) {
            ...
            case '&':
                /* Command should run in the background */
                *background = 1;
                inputBuffer[i] = '\0';
                break;
    ...
    /* Just in case the input line was greater than MAX_LINE */
    args[ct] = NULL;
}
...
int main(void)
{
    ...
    while (1) {
        ...
        /* Reset background flag for each new command */
        background = 0;
        ...
        if (pid == 0) {
             ...
             * Parent process.
             *
             * If background == 0, this is a foreground
             * process, so wait for the child to finish.
             *
             * If background == 1, this is a background
             * process, so continue immediately without
